...
//                        //            MainViewer()
//                        // The workout view.
                        SCMFreeSwimWkt(pauseAction: pauseAction, endAction: endAction)
...
struct SCMExplainFSWorkout: View {
    @State var workoutInProgress = false
    ...
    var body: some View{
        VStack{
            VStack(alignment: .center){
                ...
                Text("This is a 25M Short Course workout. Eventually you can choose the distance.")
...
struct SCMFreeSwimPaging_Previews: PreviewProvider {
