...
struct LCMFreeSwimWorkout: View {
...
struct LCMFreeSwimWorkout_Previews: PreviewProvider {
    static var pauseAction = { }
    static var endAction = { }
    
    static var previews: some View {
        LCMFreeSwimWorkout(pauseAction: pauseAction, endAction: endAction).environmentObject(WorkoutManager())
