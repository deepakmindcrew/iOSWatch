...
struct OpenWaterPaging: View {
        ...
        var body: some View {
            VStack{
                OWPagingView(workoutInProgress: self.$workoutInProgress)
...
struct OpenWaterPaging_Previews: PreviewProvider {
